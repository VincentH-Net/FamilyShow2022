...
namespace Microsoft.FamilyShow.Views
{
    ...
    public partial class DetailsView
    {
        ...
        public static readonly RoutedEvent PersonInfoClickEvent = EventManager.RegisterRoutedEvent("PersonInfoClick", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DetailsView));
        ...
        public static readonly RoutedEvent EveryoneDeletedEvent = EventManager.RegisterRoutedEvent("EveryoneDeleted", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DetailsView));
        ...
        public static readonly RoutedEvent FamilyDataClickEvent = EventManager.RegisterRoutedEvent("FamilyDataClick", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DetailsView));
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DateTime birthdate = BirthDateInputTextBox.Text.FriendlyStringToDate();
        ...
        private void FromEditTextBox_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (SpousesCombobox.SelectedItem != null)
            {
                ...
                DateTime marriageDate = FromEditTextBox.Text.FriendlyStringToDate();
        ...
        private void ToEditTextBox_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (SpousesCombobox.SelectedItem != null)
            {
                ...
                DateTime divorceDate = ToEditTextBox.Text.FriendlyStringToDate();
        ...
        private void InfoButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            WeakReferenceMessenger.Default.Send(new ShowPhotosAndStoriesMessage());
        }

        private void FamiliyDataButton_Click(object sender, RoutedEventArgs e)
        {
            MainWindow.UserInterfaceConnector.ShowFamilyDataControl();
        }
