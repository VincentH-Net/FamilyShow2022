...
namespace Microsoft.FamilyShow
{
    ...
    public partial class DiagramNode : Button
    {
        ...
        private string DateInformation
        {
            get
            {
                ...
                if (person.BirthDate != null && person.DeathDate != null)
                {
                    ...
                    int age = (displayYear >= person.DeathDate.Value.Year) ? person.Age.Value : person.Age.Value - (person.DeathDate.Value.Year - (int)displayYear);
        ...
        public Point Center
        {
            get { return new Point(location.X + (DesiredSize.Width / 2), location.Y + (DesiredSize.Height / 2)); }
        }
        ...
        {
            get { return new Point(location.X + (DesiredSize.Width / 2), location.Y + DesiredSize.Height); }
        }
