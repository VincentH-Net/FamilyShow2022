    ...
    public partial class FamilyData : UserControl
  {
    ...
    public event RoutedEventHandler CloseButtonClick
    {
      ...
      remove { RemoveHandler(CloseButtonClickEvent, value); }
        ...
        public static readonly DependencyProperty ClosedProperty = DependencyProperty.Register("Closed", typeof(ICommand), typeof(FamilyData));

        public ICommand Closed
        {
            get
            {
                return (ICommand)GetValue(ClosedProperty);
            }
            set
            {
    ...
    private void CloseButton_Click(object sender, RoutedEventArgs e)
    {
      ...
      MainWindow.UserInterfaceConnector.HideFamilyDataControl();
    }
